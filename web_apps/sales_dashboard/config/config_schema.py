...
ALL_ORDER_COLS = [
    ...
    "sales-channel", "sku", "item-status", "quantity",
    "currency", "item-price", "item-promotion-discount"
]

PAST_EVENTS_COLS = [ 
    "date_all_orders", "time_all_orders", "sales_region", "sales_country",
    "sku", "quantity", "item_price", "event_date", "event_name", "event_day"
 ]
